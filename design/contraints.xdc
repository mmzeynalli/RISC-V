...
#set_property PACKAGE_PIN U4 [get_ports {input[8]}]					
...
## LEDs
#Bank = 34, Pin name = IO_L24N_T3_34,			g			Sch name = LED0
# set_property PACKAGE_PIN T8 [get_ports output_led]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports output_led]
#Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
#set_property PACKAGE_PIN V9 [get_ports led_sign]					
...
#set_property PACKAGE_PIN T5 [get_ports {FNN[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {FNN[0]}]
#Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
#set_property PACKAGE_PIN T4 [get_ports {FNN[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {FNN[1]}]
#Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
#set_property PACKAGE_PIN U7 [get_ports {FNN[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {FNN[2]}]
#Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
#set_property PACKAGE_PIN U6 [get_ports {FNN[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {FNN[3]}]
...
#set_property PACKAGE_PIN R1 [get_ports {rc_led[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {rc_led[0]}]
#Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
#set_property PACKAGE_PIN P5 [get_ports {rc_led[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {rc_led[1]}]
...
#set_property PACKAGE_PIN R10 [get_ports b_Sign]						
#	set_property IOSTANDARD LVCMOS33 [get_ports b_Sign]
...
set_property PACKAGE_PIN B13 [get_ports register_ok]					
	set_property IOSTANDARD LVCMOS33 [get_ports register_ok]
Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports memory_ok]					
	set_property IOSTANDARD LVCMOS33 [get_ports memory_ok]
